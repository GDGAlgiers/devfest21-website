        ...
        return (
            <AgendaSection className="grid grid-cols-12 gap-2 md:py-10  md:h-screen relative pr-3 py-3 ">
                ...
                <NavigationSidebar className="lg:p-8 md:pl-3 pt-6 md:col-span-3 col-span-12 relative  md:w-8/12 md:h-5/6 h-32 ml-1 md:ml-0">
                    ...
                    />
                    <DaysList className="bg-white-lighter p-3 absolute">
                ...
                <SlidesSection className="md:col-span-9 col-span-11 relative md:h-screen h-min ml-1">
                    ...
                    >
                        <div className="bg-white-lighter py-4 w-full" />
                        <div className="bg-white-lighter mt-3">
                            <DayEvents
                    ...
                    >
                        <div className="bg-white-lighter py-4 " />
                        <div className="bg-white-lighter  mt-3 ">
                            <DayEvents
                                dayPlan={this.state.dayPlan}
                                bgColor="white"
                    ...
                    >
                        <div className="bg-white-lighter grid grid-cols-2 px-2 py-1 mb-2">
