            ...
            <Act className="pt-5">
              {props.dayPlan.map((elem, key) => (
                <div className="p-2 grid grid-cols-12 gap-1">
                  <img src={clockIcon} className="ml-auto mr-auto mx-1" width="30px"></img>
                  <div className="col-span-4 text-white md:text-lg text-sm ">
                    {elem.startTime}  -  {elem.endTime}
                  </div>
                  <div className="col-span-7">
                    <div className="font-bold md:text-lg text-sm">{elem.acticity}</div>
